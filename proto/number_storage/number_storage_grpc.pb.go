...
const (
	NumberStorageService_GetNumber_FullMethodName    = "/pb.NumberStorageService/GetNumber"
	NumberStorageService_UpdateNumber_FullMethodName = "/pb.NumberStorageService/UpdateNumber"
)
...
type NumberStorageServiceClient interface {
	...
	UpdateNumber(ctx context.Context, in *NumberRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *numberStorageServiceClient) GetNumber(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*NumberResponse, error) {
	...
	err := c.cc.Invoke(ctx, NumberStorageService_GetNumber_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *numberStorageServiceClient) UpdateNumber(ctx context.Context, in *NumberRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, NumberStorageService_UpdateNumber_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NumberStorageServiceServer interface {
	...
	UpdateNumber(context.Context, *NumberRequest) (*emptypb.Empty, error)
...
func (UnimplementedNumberStorageServiceServer) UpdateNumber(context.Context, *NumberRequest) (*emptypb.Empty, error) {
...
func _NumberStorageService_GetNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NumberStorageService_GetNumber_FullMethodName,
	}
...
func _NumberStorageService_UpdateNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NumberStorageService_UpdateNumber_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
